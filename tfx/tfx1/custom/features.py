...
SELECT
    ...
    IFNULL(days_since_last_consignment, 0) AS days_since_last_consignment,
    IFNULL(items_consigned_last_30_days, 0) AS items_consigned_last_30_days,
    IFNULL(retail_consigned_last_30_days, 0) AS retail_consigned_last_30_days,
    ...
    IFNULL(count_inquiries, 0) AS count_inquiries,
    IFNULL(days_since_last_inquiry, 0) AS days_since_last_inquiry,
...
NUMERIC_FEATURE_KEYS = [
    ...
    'items_consigned_last_30_days',
    'retail_consigned_last_30_days',
    'lifetime_nps',
